...
| Title      | \${[incident.name](http://incident.name)} |
...
- Split the indicators selected into their different types, and store it within a context key:  
...
| Indicator Title     | XSOAR Incident \${[incident.id](http://incident.id)} Indicator                  |
...
| Category          | Security                                                                                                                                                                                                                                                        |
| Short Description | #\${[incident.id](http://incident.id)} \| ATP Indicator Submission                                                                                                                                                                                              |
